...
def compute_animations(adata,
    ...
    dyn.pd.fate(adata, basis='umap_perturbation', init_cells=progenitor_list, interpolation_num=100,
...
class MultiomicVectorField:
    ...
    def cell_velocities(self,
        ...
        # ... compute PCA
        adata_multi = dyn.pp.pca(adata=adata_multi,
                                 n_pca_components=n_pcs,
                                 random_state=random_seed)

        # ... compute the appropriate dimensional reduction
        dyn.tl.reduceDimension(adata_multi,
                               basis='pca',
                               cores=cores,
                               n_pca_components=n_pcs,
                               n_components=2,
        ...
        dyn.tl.cell_velocities(adata_multi,
                               basis='pca',
    ...
    def plot_cell_wise_vectors(self,
        ...
        dyn.pl.cell_wise_vectors(self.multi_adata,
                                 basis='umap',
                                 color=[color],
                                 pointsize=0.1,
                                 quiver_length=6,
    ...
    def plot_streamline_plot(self,
        ...
        fig, ax = plt.subplots(figsize=figsize)
        dyn.pl.streamline_plot(self.multi_adata,
                               basis='umap',
                               color=[color],
    ...
    def plot_topography(self,
        ...
        fig, ax = plt.subplots(figsize=figsize)
        dyn.pl.topography(self.multi_adata,
                          basis='pca',
                          background='white',
                          color=color,
                          frontier=True,
    ...
    def predict_perturbation(self,
        ...
        perturbed_multi_adata = dyn.pd.perturbation(self.multi_adata,
                                                    genes=gene,
                                                    expression=expression,
                                                    emb_basis='umap')
        dyn.pl.streamline_plot(self.multi_adata, color=["cell_type", gene],
